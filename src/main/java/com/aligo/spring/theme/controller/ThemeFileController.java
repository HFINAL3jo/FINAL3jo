...
public class ThemeFileController {
	...
	public String photoUpload(HttpServletRequest request, PhotoVo vo){
	    ...
	    try {
	        if(vo.getFileData() != null && vo.getFileData().getOriginalFilename() != null && !vo.getFileData().getOriginalFilename().equals("")){
	            ...
	            //파일 기본경로 _ 상세경로
	            String path = defaultPath + "\\tuploadFiles";           
	        ...
	        ///////////////// 서버에 파일쓰기 /////////////////
	            ...
	            file_result += "&bNewLine=true&sFileName="+original_name+"&sFileURL=/resources/tuploadFiles/"+realname;
	        } else {
	...
	public void multiplePhotoUpload(HttpServletRequest request, HttpServletResponse response){
	    try {
	         ...
	         //파일 기본경로 _ 상세경로
	         String filePath = dftFilePath + "\\tuploadFiles";
	         ...
	         sFileInfo += "&sFileURL="+"resources/tuploadFiles/"+realFileNm;
...
@RequestMapping("html5PhotoUpload.do")
		...
		for(int i=0; i<allow_file.length; i++) { 
			...
			if(cnt == 0) {
			 ...
			 print.close(); 
				 ...
				 String dftFilePath = request.getSession().getServletContext().getRealPath("resources"); 
				 //파일 기본경로 _ 상세경로 
				 String filePath = dftFilePath + "\\tuploadFiles" + File.separator; 
				 File file = new File(filePath); 
				 if(!file.exists()) { 
					 file.mkdirs(); 
					 } 
