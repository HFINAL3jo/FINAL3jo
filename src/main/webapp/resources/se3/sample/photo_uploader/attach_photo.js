    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/spring/blogMultiplePhotoUpload.do'; 	//upload URL
...
// 			sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 			sUrl : '/spring/blogPhotoUpload.do',								//파일업로드를 처리하는 페이지
 			sCallback : 'resources/se3/sample/photo_uploader/callback.html',		//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
