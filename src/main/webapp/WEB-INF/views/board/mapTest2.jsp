...
<input type="text" id="searchAddr">
<button onclick="addrMap();">검색</button>
</div>
...
/* // 주소로 좌표를 검색합니다
geocoder.addressSearch('동대문', function(result, status) {
    // 정상적으로 검색이 완료됐으면 
     if (status === kakao.maps.services.Status.OK) {
        ...
        var infowindow = new kakao.maps.InfoWindow({
            content: '<div style="width:150px;text-align:center;padding:6px 0;">장소 1</div>'
        });
...
function addrMap() {
	var searchAddr = document.getElementById('searchAddr').value;
