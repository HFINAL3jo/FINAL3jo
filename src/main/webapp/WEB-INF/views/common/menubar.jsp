							...
							<ul class="navbar-nav">
								...
								<li class="nav-item dropdown"><a
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
										<a class="dropdown-item" href="theme.do">History Theme</a> <a
											class="dropdown-item" href="theme.do">Food Theme</a> <a
											class="dropdown-item" href="theme.do">Shopping Theme</a> <a
											class="dropdown-item" href="theme.do">Festival Theme</a> <a
											class="dropdown-item" href="theme.do">Night View Theme</a> <a
											class="dropdown-item" href="theme.do">Museum Theme</a> <a
											class="dropdown-item" href="theme.do">Exotic Theme</a>
									</div></li>
								<li class="nav-item"><a class="nav-link" href="post.do">Posting</a>
								</li>
								...
								<li class="nav-item dropdown"><a
									class="nav-link dropdown-toggle" href="" id="navbarDropdown_1"
									role="button" data-toggle="dropdown" aria-haspopup="true"
									aria-expanded="false"> themePosting Test </a>
									<div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
										<a class="dropdown-item" href="themeInsertView.do">Test1</a> <a
											class="dropdown-item" href="blogdetail.do">Test2</a>
									</div></li>
							</ul>
						</div>
