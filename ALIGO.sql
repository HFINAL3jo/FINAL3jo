...
DROP TABLE MY_REVIEW CASCADE CONSTRAINTS;
DROP TABLE CONTENT;
...
CREATE TABLE BLOG_LIST(
  ...
  BCONTENT LONG NOT NULL,
  BADDRESS VARCHAR2(1000),
  BADDRESSH VARCHAR2(1000),
  B_CREATE_DATE DATE DEFAULT SYSDATE,
  B_MODIFY_DATE DATE DEFAULT SYSDATE,
  B_VIEWS NUMBER DEFAULT 0,
  B_LIKES NUMBER DEFAULT 0,
  B_STATUS VARCHAR2(5) DEFAULT 'Y' CHECK (B_STATUS IN('Y','N','X')),
  BTEL VARCHAR2(50),
  BFEE VARCHAR2(500),
  BHOURS VARCHAR2(1000),
  BTRANS VARCHAR2(1000),
  BCODE VARCHAR2(3) REFERENCES BCATEGORY ON DELETE CASCADE,
  BFILE_STATUS VARCHAR2(5) DEFAULT 'Y' CHECK (BFILE_STATUS IN ('Y','N'))
);

ALTER TABLE BLOG_LIST MODIFY(BCONTENT CLOB);

CREATE TABLE BLOG_FILES(
  BID NUMBER,
  B_ORIGINAL_FILE VARCHAR2(4000),
  B_MODIFY_FILE VARCHAR2(4000)  
);

CREATE TABLE MY_REVIEW(
  BWRITER VARCHAR2(500) REFERENCES MEMBER(NICKNAME) ON DELETE CASCADE,
  BID NUMBER REFERENCES BLOG_LIST ON DELETE CASCADE
);
...
CREATE TABLE REPORTS(
  ...
  REPORT_CONTENT_ENSURE VARCHAR2(1000),
  REPORT_SDATE DATE,
  REPORT_EDATE DATE,
...
--BCATEGORY
INSERT INTO BCATEGORY VALUES('B1','INFORMATION');
INSERT INTO BCATEGORY VALUES('B2','TRANSPORTATION');
INSERT INTO BCATEGORY VALUES('B3','TRAVEL GUIDE');
INSERT INTO BCATEGORY VALUES('B4','ACCOMMODATION');
INSERT INTO BCATEGORY VALUES('B5','REVIEWS');
INSERT INTO BCATEGORY VALUES('B6','ETC');
